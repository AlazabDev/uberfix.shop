...
function calculateStats(requests: MockRequest[]) {
  return calculateDashboardStats(requests);
}
...
describe("Dashboard Stats - Calculation Logic", () => {
  ...
  it("treats draft and inspection workflow stages as active requests", () => {
    const requests: MockRequest[] = [
      { id: '1', status: 'Open', workflow_stage: 'draft', priority: 'low', estimated_cost: null, actual_cost: null, created_at: '2020-01-01' },
      { id: '2', status: 'InProgress', workflow_stage: 'inspection', priority: 'high', estimated_cost: null, actual_cost: null, created_at: '2020-01-01' },
    ];
  ...
  it("treats closed requests as completed for KPI completion rate", () => {
    const requests: MockRequest[] = [
      { id: '1', status: 'Closed', workflow_stage: 'closed', priority: null, estimated_cost: null, actual_cost: null, created_at: '2020-01-01' },
      { id: '2', status: 'Completed', workflow_stage: 'completed', priority: null, estimated_cost: null, actual_cost: null, created_at: '2020-01-01' },
      { id: '3', status: 'Open', workflow_stage: 'submitted', priority: null, estimated_cost: null, actual_cost: null, created_at: '2020-01-01' },
    ];
